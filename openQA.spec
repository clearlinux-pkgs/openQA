...
#
Name     : openQA
Version  : 4.6.102d1698
Release  : 13
URL      : https://github.com/os-autoinst/openQA/archive/102d1698335b6bd02ea8f10d38fcc2ec4ab184e9/openQA-4.6.102d1698.tar.gz
Source0  : https://github.com/os-autoinst/openQA/archive/102d1698335b6bd02ea8f10d38fcc2ec4ab184e9/openQA-4.6.102d1698.tar.gz
...
%prep
%setup -q -n openQA-102d1698335b6bd02ea8f10d38fcc2ec4ab184e9
cd %{_builddir}
tar xf %{_sourcedir}/openQA-dep-latest.tar.gz
cd %{_builddir}/openQA-102d1698335b6bd02ea8f10d38fcc2ec4ab184e9
mkdir -p assets
cp -r %{_builddir}/openQA-dep-latest/* %{_builddir}/openQA-102d1698335b6bd02ea8f10d38fcc2ec4ab184e9/assets
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579300481
...
cp %{_builddir}/openQA-102d1698335b6bd02ea8f10d38fcc2ec4ab184e9/COPYING %{buildroot}/usr/share/package-licenses/openQA/4cc77b90af91e615a64ae04893fdffa7939db84c
%make_install
...
/usr/share/package-licenses/openQA/4cc77b90af91e615a64ae04893fdffa7939db84c
